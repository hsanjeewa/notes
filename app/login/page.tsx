...
function LoginPage() {
  ...
  return (
    <main className='flex min-h-screen items-center justify-center px-4 pb-24'>
      <div className="flex bg-popover relative w-full max-w-sm flex-col items-center rounded-lg border p-8">
        <h1 className={`mb-8 text-2xl font-semibold ${isPending && "opacity-0"}`}>Login</h1>
        {isPending && (
        ...
        <form className={`flex w-full flex-col gap-4 ${isPending && "opacity-0 -z-10"}`} action={handleClickLoginButton}>
